...
осуществления балансировки нагрузки между ними.
...
Для приближения к производственным условиям, создадим три сети в докере:
...
Приблизительно спустя 30s в отдельном терминальном окне останавливаем docker-контейнеры MySQL slave-узла и одного из 
экземпляров auth микросервиса:
```shell script
