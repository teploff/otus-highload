...
масштабируемостью экземпляров микросервисов **counter** и **destrib-syncer**, если, безусловно, такая проблема
...
В виде приближенной схемы алгоритма, действия микросервиса **destrib-syncer** будут выглядеть следующим образом.
Создание чатов между собеседниками: </br>
<p align="center">
    <img src="static/counter/create_chat_algorithm.png">
</p>

Отправка сообщений от пользователей к пользователям:</br>
<p align="center">
    <img src="static/counter/send_message_algorithm.png">
</p>

И наконец выгрузка сообщение в виде offset и limit'а:</br>
<p align="center">
