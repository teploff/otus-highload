...
type UserRepository interface {
	...
	GetByLimitAndOffsetExceptUserID(tx *sql.Tx, userID string, offset, limit int) ([]*User, error)
	GetByPrefixOfNameAndSurname(tx *sql.Tx, prefix string, offset, limit int) ([]*User, int, error)
