...
type SocialService interface {
	GetQuestionnaires(ctx context.Context, userID string, offset, limit int) ([]*Questionnaire, int, error)
	GetQuestionnairesByNameAndSurname(ctx context.Context, prefix string, offset, limit int) ([]*Questionnaire, int, error)
}
